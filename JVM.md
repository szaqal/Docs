...
```
root@a499d07176e9:/opt/wildfly# java -XX:+PrintFlagsFinal -version
[Global flags]
...
ccstrlist CompileOnly                              =                                           {product} {default}
 ...
 uint64_t MaxDirectMemorySize                      = 0                                         {product} {default}
   ...
   size_t MaxHeapSize                              = 1879048192                                {product} {ergonomic}
   ...
   size_t MaxNewSize                               = 1127219200                                {product} {ergonomic}
